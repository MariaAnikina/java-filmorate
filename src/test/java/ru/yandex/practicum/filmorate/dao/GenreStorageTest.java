...
public class GenreStorageTest {
    ...
    @Test
    void shouldAddDeleteGetFilmGenres(@Qualifier("filmDbStorage") FilmStorage filmStorage) {
        Film film = new Film("Оно", "Шарик",
                LocalDate.parse("2017-10-20"), 90, new RatingMPA(1, "G"));
